...
const content = {
  fr: {
    ...
    intro: "Je conçois des produits web de bout en bout : systèmes front-end, logique métier, données, intégrations et mise en production.",
    ...
    problemsLabel: "02 — PROBLÈMES COMPLEXES",
    ...
    principlesLabel: "03 — FAÇON DE TRAVAILLER",
  ...
  en: {
    ...
    eyebrow: "ENGINEERING PROFILE · ALIASKAR MALABAEV",
    intro: "I build web products end to end: front-end systems, domain logic, data, integrations and production delivery.",
    ...
    problemsLabel: "02 — COMPLEX PROBLEMS",
