...
const copy = {
  fr: {
    ...
    note: "Le bouton prépare votre demande par email. Vous pourrez la relire avant de l’envoyer.",
  ...
  en: {
    ...
    note: "The button prepares your request by email. You can review it before sending.",
